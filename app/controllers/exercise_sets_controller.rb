class ExerciseSetsController < ApplicationController
  before_action :retrieve_exercise_and_session, except: [:retrieve_set, :show]
  before_action :retrieve_set, only: [:edit, :update, :destroy]

  def retrieve_exercise_and_session
